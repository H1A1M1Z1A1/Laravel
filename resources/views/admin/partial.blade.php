        ...
        <ul class="nav">
          <li class="nav-item profile">
            <div class="profile-desc">
              ...
              <a href="admin/#" id="profile-dropdown" data-bs-toggle="dropdown"><i class="mdi mdi-dots-vertical"></i></a>
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" data-bs-toggle="collapse" href="admin/#ui-basic" aria-expanded="false" aria-controls="ui-basic">
              <span class="menu-icon">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"> <a class="nav-link" href="{{url('show_product')}}">Dropdowns</a></li>
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" data-bs-toggle="collapse" href="admin/#auth" aria-expanded="false" aria-controls="auth">
              <span class="menu-icon">
